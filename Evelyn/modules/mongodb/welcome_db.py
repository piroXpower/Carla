...
def set_welcome(chat_id: int, w_text, id=None, hash=None, ref=None)
  welcome.update_one({"chat_id": chat_id, "text": "w_text", "id": id, "hash": hash, "ref": ref, "mode": True}, upsert=True)
...
def toggle_welcome(chat_id: int, mode):
 ...
 welcome.insert_one({"chat_id": chat_id, "text": None, "id": None, "hash": None, "ref": None, "mode": mode})
