...
class LOCKS(BASE):
 ...
 def __init__(self, chat_id, media, audio, video, sticker, gif, inline, all, emojigame, phone, photo, url, location, invitelink, forward, document, contact, command, button, bot):
...
def change_mode(chat_id, media=False, audio=False, video=False, sticker=False, gif=False, inline=False, all=False, emojigame=False, phone=False, photo=False, url=False, location=False, invitelink=False, forward=False, document=False, contact=False, command=False, button=False, bot=False):
