...
async def _(event):
    if (
        event.text.startswith("!locktypes")
...
async def chat_event(event, args):
    ...
    if args == "text":
        await tbot.edit_permissions(
            event.chat_id,
            send_messages=False,
            send_gifs=not event.chat.default_banned_rights.send_gifs,
            send_stickers=not event.chat.default_banned_rights.send_stickers,
            send_games=not event.chat.default_banned_rights.send_games,
            embed_link_previews=not event.chat.default_banned_rights.embed_links,
            send_inline=not event.chat.default_banned_rights.send_inline,
            send_media=not event.chat.default_banned_rights.send_media,
            send_polls=not event.chat.default_banned_rights.send_polls,
            invite_users=not event.chat.default_banned_rights.invite_users,
        )
    elif args == "sticker":
        await tbot.edit_permissions(
            event.chat_id,
            send_messages=not event.chat.default_banned_rights.send_messages,
            send_gifs=not event.chat.default_banned_rights.send_gifs,
            send_stickers=False,
            send_games=not event.chat.default_banned_rights.send_games,
            embed_link_previews=not event.chat.default_banned_rights.embed_links,
